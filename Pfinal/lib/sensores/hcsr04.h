...
#define HCSR04_MAX_DISTANCE_CM 400     // Distancia máx teórica
...
#define HCSR04_LEFT_TRIG_PIN   2   // GP2
#define HCSR04_LEFT_ECHO_PIN   3   // GP3
#define HCSR04_RIGHT_TRIG_PIN  4   // GP4
#define HCSR04_RIGHT_ECHO_PIN  5   // GP5
